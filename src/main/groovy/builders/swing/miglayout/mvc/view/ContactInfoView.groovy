package builders.swing.miglayout.mvc.view
            ...
            frame = frame(
                ...
                panel(id: "infoPanels", constraints: "wrap, span 2") {
                    ...
                    panel(id: "summary", visible: false, constraints: "hidemode 3", layout: new MigLayout("fill", "[][]", "[]10[]")) {
                        ...
                        label(text: "First name", constraints: "width 100!")
                        textField(id: "firstName", constraints: "width 170!, wrap, align right", text: bind {
                            contactInfoModel.firstName
                        })

                        label(text: "Surname")
                        textField(id: "surName", constraints: "width 170!, wrap", text: bind {
                            contactInfoModel.surName
                        })

                        label(text: "Address", constraints: "width 100!")
                        textField(id: "address", constraints: "width 170!, wrap, align right", text: bind {
                        ...
                        label(text: "E-mail", constraints: "width 100!")
                        textField(id: "email", constraints: "width 170!, wrap, align right", text: bind {
